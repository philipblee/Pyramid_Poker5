...
import threading
import pickle
""" pp_client3 builds off of chat_server
v3. add the dealing of hands and deck of cards, receives hand instead of welcome message
...
def receive_message_from_server(sck, m):
    ...
    while True:
        bytes_from_server = sck.recv(4096)
