        ...
        if play_hand[i] == True:
            for cardlist in hands_stored[i]:
                ...
                for j in [6, 5, 4, 3, 2, 1]:
                    ...
                    x = x1
    # for i  in range(6):
    #     print (sd.player_win_points)
    #     print (sd.player_points)

    print ("Server Received", idx, hand)

    # print ("Results so far after ", idx, "players")
    # for i  in range(6):
    #     print (player_names[i], sd.player_win_points[i], sd.player_points[i])


    # send to all client_sockets
    # for client_socket in client_sockets:
    #     print ("sending hands_stored")
    #     pickled_hands_stored = pickle.dumps(hands_stored)
    #     client_socket.send(pickled_hands_stored)
