...
if MODE == "Interactive":
    ...
    w = tk.Canvas(window, height=810 - 2*Y_GAP, width= 13.2 * 80, background="pink", relief="raised")
    ...
    finished_setup_button.place(x=1080 - 250, y=225-2*Y_GAP, width=120, height=24)
    toggle_button = tk.Button(window, text="Toggle", font=12, command=toggle_finished, state='disabled')
    toggle_button.place(x=1080 - 120 + 10, y=225-2*Y_GAP, width=90, height=24)
