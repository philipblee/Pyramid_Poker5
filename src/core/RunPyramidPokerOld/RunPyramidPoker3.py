...
if MODE == "Batch":
    ...
    for k_num in range (NUMBER_OF_HANDS):
        ...
        for i in range(6):
            print ('{:>6}'.format(str(global_variables.random_seed)),)
            print ('{:>6}'.format(str(global_variables.player_minimums[i])),)
            print ('{:>8}'.format(player_names[i]), str(play_six_hands.player_wilds[i]),)
            print ('{:>8}'.format(str(play_six_hands.player_score_hand20[i])),)
            print ('{:>8}'.format(str(play_six_hands.player_score_prediction[i])),)
            print ('{:>9}'.format(str(play_six_hands.play_hand20_quality[i])),)
            print ('{:>9}'.format(str(play_six_hands.hand20_signal[i])),)
            print ('{:>8}'.format(str(play_six_hands.points_stored[i][0])),)
            print ('{:>6}'.format(str(play_six_hands.play_hand20[i])),)
            print ('{:>6}'.format(str(play_six_hands.player_points[i])),)
            points_per_player = round(play_six_hands.player_points[i]/float(sd.number_players),1)
            print ('{:>6}'.format(str(points_per_player)),)
            print ('{:>6}'.format(str(sd.player_ante[i])),)
            print ('{:>6}'.format(str(sd.player_surrender[i])),)
            print ('{:>6}'.format(str(player_totals[i])),)
            print ('{:>6}'.format(str(player_running_wilds[i])),)
            print ('{:>6}'.format(str(player_running_ante[i])),)
            ...
            print ('{:>6}'.format(str(player_running_plays[i])),)
            print ('{:>6}'.format(str(player_running_wins[i])),)
            print ('{:>6}'.format(k_num + 1),)
            print ('{:>6}'.format(player_running_totals[i]/(k_num + 1)),)
            if play_six_hands.play_hand20[i] == True:
                running_play += 1
        ...
        print ("running average points stored", running_average_points_stored)
        running_in_range_pcnt = float(running_in_range)/(running_in_range+running_out_of_range)
        print ("running points_stored and points_per_player in range pcnt", running_in_range_pcnt * 100)
        ...
        print ("running prediction and points_stored in range pcnt", running_prediction_in_range_pcnt * 100)
        running_play_pcnt = float(running_play)/(running_no_play + running_play)
        print ("running play pcnt", running_play_pcnt * 100)
        game_string = ""
        for i in range(6):
            ...
            game_string += '{:>6}'.format(str(player_running_wilds[i])) + ', '
            game_string += '{:>6}'.format(str(player_running_ante[i])) + ', '
...
if MODE == "Solve" or MODE == "Text":
    ...
    next_setup_button = Button(top, text="Next User Input", command=show_deck_of_cards)
